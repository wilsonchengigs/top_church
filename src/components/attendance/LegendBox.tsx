...
import { PINK_BADGE_URL, COLOR_BADGE_URL } from "../../constants";
...
function BadgeCycleIcon() {
  ...
  const duration = 1.2; // seconds per badge
  return (
      ...
      <div style={styles.col}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "#374151" }}>
          <div style={{ width: size, height: size, flexShrink: 0 }}>
            <img src={PINK_BADGE_URL(1)} alt="" width={size} height={size} style={{ display: "block", opacity: 0.9 }} />
          </div>
          <span>未完成</span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "#374151" }}>
